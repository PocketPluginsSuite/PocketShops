...
class Main extends PluginBase implements Listener{
	...
	public function onEnable(){
        ...
        $defaultConfig = [
            ...
            "plugin_info" => [
                "documentation" => "https://github.com/al5ina5/PocketShops/",
                "release" => "https://underforums.com",
                "author" => "Sebastian Alsina",
                "github" => "https://github.com/al5ina5/",
                "discord" => "https://invite.gg/underforums/",
        ...
        foreach($this->shops as $shop => $info) {
            $perm = new Permission("pocketshops.shop.$shop", "Access to the '$shop' shop.");
    ...
    public function openShop(string $shopName, Player $player) {
        ...
        if (!$player->hasPermission("pocketshops.shop.$shopName")) {
